...
const config = {
  title: 'Bradfield CS',
  tagline: 'Seeking mastery in software engineering bit by bit',
  url: 'https://bradfield.dwf.dev',
  baseUrl: '/',
  onBrokenLinks: 'warn',
  ...
  projectName: 'bradfield', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/farlowdw/bradfield/tree/master/',
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Overview',
                to: '/docs/supplemental-resources/introduction',
              },
            ],
          },
          {
            title: 'Bradfield Blog',
            items: [
              {
                label: 'The cost of forsaking C',
                href: 'https://blog.bradfieldcs.com/the-cost-of-forsaking-c-113986438784',
              },
            ],
          },
          {
